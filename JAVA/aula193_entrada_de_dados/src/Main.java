...
public class Main {
	...
	public static void main(String[] args) {
		...
		nome1 = sc.nextLine(); //Lê o texto até a quebra de linha
		System.out.print(" Digite o salario da primeira pessoa: ");
		salario1 = sc.nextDouble(); //Tipo double
		
		System.out.print(" Digite o nome da segunda pessoa: ");
		sc.nextLine(); //Limpando a quabra de linha
		nome2 = sc.nextLine();
		...
		sexo = sc.next().charAt(0); //Leitura de um unico caractere
